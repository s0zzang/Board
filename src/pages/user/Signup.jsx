...
function Login() {
  ...
  const onSubmit = async (formData) => {
    try {
      formData.type = "user"; // 일반 회원 전용 회원가입
      ...
      alert(
        `${res.data.item.name}님 가입이 완료되었습니다. \n로그인 후에 이용하세요.`
      );
      navigate("/user/login");
    } catch (err) {
  ...
  return (
    <div className="min-w-80 flex-grow flex items-center justify-center p-6">
